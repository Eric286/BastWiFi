...
about: Report a bug or unexpected behavior while using the BastWifi.
...
Any feedback/suggestions should be discussed on the [feedback section](https://github.com/ElectronicCats/BastWiFi/issues):
